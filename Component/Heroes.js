  ...
  render(){
    return(
      <View style={nbStyles.subtitle}>
          ...
          <Image
           style={{alignSelf: 'center', width: 320, height:180, marginBottom: 5, marginTop:10, }}
            source={{uri: 'https://assets.jalantikus.com/assets/cache/516/290/userfiles/2018/05/17/karina-d741d.jpeg'}}
          />

          <Image
           style={{alignSelf: 'center', width: 320, height:180, marginBottom: 5, marginTop:5, }}
          ...
          <Image
           style={{alignSelf: 'center', width: 320, height:180, marginBottom: 30, marginTop:5, }}
